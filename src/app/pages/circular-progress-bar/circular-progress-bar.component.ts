...
@Component({
  ...
  template: `
    <GridLayout [height]="height" [width]="height" verticalAlignment="top" class="m-x-auto m-y-auto">
      <RadRadialGauge>
...
<!--          </RadialBarIndicator>-->
      ...
      <Label [text]="text" [color]="textColor" [fontSize]="textSize" class="m-x-auto m-y-auto gagalin-regular" [marginTop]="offset"></Label>
    </GridLayout>
  `,
